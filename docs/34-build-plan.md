...
| **2 — The ceremony** — **BUILT AND GAUNTLETED 2026-08-29** | The meter pill, the Turn sheet with the arcade Tally, the blessing, petal rows on the Almanac, unlock rows in the seed picker, the season tint | Plays a full year on the phone; *gift or loss?* | A (surface half) |
| **3 — Fall and the strip** — **FIRST HALF BUILT AND GAUNTLETED 2026-08-29; the map retirement and the dock swap remain, blocked on re-homing the meadow** | The horizontal season strip, hedge gates, Fall's board + eight crops + windfall + Century Bloom, ~~map retirement, the Stand's dock entry~~ | Turn 1 → the gate opens → a Fall day | A (world half) |
| **3.5 — The Big Five** — owner-specced 2026-08-30 | The dock rebuild per [36-hud-and-dock.md](36-hud-and-dock.md): five main buttons + the floating Upgrades/Power-up pair; meter pill and album star retire into it | Spike vs the owner's reference screenshot, then the navigation lap | interlude |
| **3.6 — The cleanup round** — owner-ruled 2026-08-30 | The three ruled fixes (discover backfill + nearest-to-complete strip, Stand rep paused behind a data flag, one padlock meaning) plus the owner's review kit of cheats (time-warp, summon creatures, grant seeds/boosts/packs) | The five ruled behaviors, walked; the review kit driven once | interlude |
| **3.7 — Numbers & News** — owner-ruled 2026-08-30 | The Numbers Pass (every button says what you get and what you have; the picker tells the truth about petals), the What's New popup with owner art and a fresh-start "Got it!", and order gold raised to windfall feel | Buy a petal and watch every number move; the popup once and never again; an order that feels worth filling | interlude |
| **3.8 — The polish round** — owner-ruled 2026-08-30 | Turn-ready shine, "upgrades" terminology, the power-up faucet audit + first-days generosity, petal descriptions at zero pips, the vertical-gesture ruling + down-gate placeholder, the post-Turn swipe coach, the bed-chip reposition, the Cards visual pass | Before/after screenshots; the seven behaviors walked on a phone | interlude |
| **3.9 — The Sky Pass** — owner-specced 2026-08-30 | The Weather Ladder per [41-weather-staging.md](41-weather-staging.md): all four skies staged, fronts, the world acknowledging, the music rearranging, two math nudges — behind the **motion gate** (owner tunes each sky's feel on the spike's sliders before anything integrates) | Each sky's sequence on the motion stage, then in the live garden | interlude |
