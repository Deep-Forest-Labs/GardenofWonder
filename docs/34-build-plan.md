...
| --- | --- | --- | --- |
| **1 — The engine** — **BUILT 2026-08-29, awaiting the owner's verdict** | Year state, `credit()`, the mint + Tally math, `turnYear()`, unlock prices, petal effects, quest re-keys, migration, dev-tools drivers, **the whole sim-test bill** (items 1–6, 8–18 asserted; suite at 1,043) | Numbers, via a cheat-driven year — no UI yet | A (sim half) |
